...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { from_name: @letter.from_name, message: @letter.message, to_name: @letter.to_name } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { from_name: @letter.from_name, message: @letter.message, to_name: @letter.to_name } }
